...
export const summary: Summary = {
  SWE: "**Software Engineer** — Designed and delivered scalable systems from event-driven payment architectures to real-time biosensing pipelines. Built **AWS event-driven backends** (EventBridge, Lambda, DynamoDB) and led agile teams to deliver **80+ production features**.",

  AIMR: "**AI/ML Engineer** — AI/ML Engineer — Built clinical-grade CV/MR real-time pipelines using **PyTorch** for 4DMedical's XV Scanner and orthodontic miniscrew placement. Skilled in prototyping MR applications across **Unity, Meta Quest 3, HoloLens 2**, etc.",
